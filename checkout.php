                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="Visa"  class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Visa<img src="images/visa.png" height="23px" width="20px"></span> </label>
                                            </li>
                                        </ul>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#"> <img src="images/visa.png" alt="visa"height="23px" widht="26px"> </a>
                                        </li>
                                        <li>
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Nelliady, Karaveddy</p>
                                    <h5>Phone: +941291682</a></h5> </div>
